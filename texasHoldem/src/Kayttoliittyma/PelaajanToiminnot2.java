...
public class PelaajanToiminnot2 {
    ...
    public static int pelaajanToiminnot(Pelaaja pelaaja) {
        ...
        while (true) {
            ...
            int valinta = Pelipoyta.kysyInt(pelaaja.getNimi() + ": Mitä haluat tehdä? (1) korota (2) check/maksu (3) luovuta : ");
            if (valinta == 1) {
                return 1;
            } else if (valinta == 2) {
                return 2;
 ...
 */
    public static int korotus(Pelaaja pelaaja, Peli peli) {
        ...
        while (true) {
            ...
            maara = Pelipoyta.kysyInt(pelaaja.getNimi() + ": Paljon haluat korottaa?");
            ...
            Pelipoyta.kysyString("Rahamääräsi ei riitä tai korotit negatiivisellä arvolla tai korotit nollalla");
        }
        pelaaja.toimi();
        return maara;
    }
