...
public class TodennakoisyysTarkistaja {
    ...
    public double TarkistaTodennakoisyysEnnenFloppia(Kasi kasi) {
        ...
        if (kasi.getKortti(0).getArvo() == 5) {     // Ensimmäinen kortti on 5.
        ...
        if (kasi.getKortti(0).getArvo() == 6) {     // Ensimmäinen kortti on 6.
        ...
        if (kasi.getKortti(0).getArvo() == 7) {     // Ensimmäinen kortti on 7.
        ...
        if (kasi.getKortti(0).getArvo() == 8) {     // Ensimmäinen kortti on 8.
        ...
        if (kasi.getKortti(0).getArvo() == 9) {     // Ensimmäinen kortti on 9.
        ...
        if (kasi.getKortti(0).getArvo() == 10) {     // Ensimmäinen kortti on 10.
        ...
        if (kasi.getKortti(0).getArvo() == 11) {     // Ensimmäinen kortti on 11.
        ...
        if (kasi.getKortti(0).getArvo() == 12) {     // Ensimmäinen kortti on 12.
        ...
        if (kasi.getKortti(0).getArvo() == 13) {     // Ensimmäinen kortti on 13.
            if (kasi.getKortti(1).getArvo() == 13) {
                return 0.8211;
            } else if (kasi.getKortti(1).getArvo() == 1) {
                if (kasi.getKortti(0).getMaa() == kasi.getKortti(1).getMaa()) {
                    return 0.6623;
